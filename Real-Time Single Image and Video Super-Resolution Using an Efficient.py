...
model_checkpoint_callback = keras.callbacks.ModelCheckpoint(filepath=checkpoint_filepath, save_weights_only=True, monitor="loss", mode="min", save_best_only=True,)
...
#for i in range(10):
#    plt.imshow(plt.imread(test_img_paths[i]))
#    plt.imshow(get_lowres_image(load_img(test_img_paths[i]), upscale_factor))
#    plt.show()
